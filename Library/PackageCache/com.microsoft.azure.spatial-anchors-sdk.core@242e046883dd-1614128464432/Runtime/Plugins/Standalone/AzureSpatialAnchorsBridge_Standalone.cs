...
namespace Microsoft.Azure.SpatialAnchors
{
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_release(IntPtr handle);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_addref(IntPtr handle);
        [DllImport(DllName, EntryPoint="ssc_cloud_spatial_anchor_map_get_identifier_wide", CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_get_identifier(IntPtr handle, [MarshalAs(UnmanagedType.LPWStr)] out string result);
        [DllImport(DllName, EntryPoint="ssc_cloud_spatial_anchor_map_get_name_wide", CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_get_name(IntPtr handle, [MarshalAs(UnmanagedType.LPWStr)] out string result);
    ...
    /// </summary>
    public partial class CloudSpatialAnchorMap
    {
        internal IntPtr handle;
        internal CloudSpatialAnchorMap(IntPtr ahandle, bool transfer)
        {
            this.handle = ahandle;
            if (!transfer) Microsoft.Azure.SpatialAnchors.NativeLibrary.ssc_cloud_spatial_anchor_map_addref(ahandle);
        }
        ~CloudSpatialAnchorMap()
        {
            Microsoft.Azure.SpatialAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.SpatialAnchors.NativeLibrary.ssc_cloud_spatial_anchor_map_release(this.handle));
            this.handle = IntPtr.Zero;
        }
        ...
        public string Identifier
        {
            ...
            {
                string result;
                Microsoft.Azure.SpatialAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.SpatialAnchors.NativeLibrary.ssc_cloud_spatial_anchor_map_get_identifier(this.handle, out result));
                return result;
            }
        }
        ...
        public string Name
        {
            ...
            {
                string result;
                Microsoft.Azure.SpatialAnchors.NativeLibraryHelpers.CheckStatus(this.handle, Microsoft.Azure.SpatialAnchors.NativeLibrary.ssc_cloud_spatial_anchor_map_get_name(this.handle, out result));
                return result;
            }
        }
