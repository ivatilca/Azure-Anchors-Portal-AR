...
namespace Microsoft.Azure.SpatialAnchors
{
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_get_identifier(IntPtr handle, [MarshalAs(UnmanagedType.LPStr)] out string result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.SpatialAnchors.status ssc_cloud_spatial_anchor_map_get_name(IntPtr handle, [MarshalAs(UnmanagedType.LPStr)] out string result);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
